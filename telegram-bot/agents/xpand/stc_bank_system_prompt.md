...
## Creative-first concept board
For each serious STC request, generate twelve genuinely different advertising directions: premium human moment, narrative still life, material metaphor, monumental environment, threshold/access, object transformation, travel/journey, authentic Saudi/Gulf commerce, camera-led revelation, conceptual sculpture, quiet luxury and consequence-led realism. These are different creative grammars, not color treatments. Vary mechanism, hero relationship, environment, spatial structure, camera family, materials, human presence and emotional temperature. At least three directions must work without a phone and two without a POS; no more than three may use a visible hand, two may use a POS as hero or two may use an indoor retail counter. Concept checks rank and repair ideas; they never block rendering or produce a creative rejection message.
