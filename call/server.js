...
async function initDatabase() {
  ...
  // XPAND Content Command: every visible item originates from these durable
  // records; the public tool never fabricates campaign, task, or occasion data.
  await pool.query(`
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS xpand_content_tasks (
      id UUID PRIMARY KEY,
      campaign_id UUID REFERENCES xpand_content_campaigns(id) ON DELETE CASCADE,
      user_id BIGINT NOT NULL,
      title TEXT NOT NULL,
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS xpand_content_sources (
      id UUID PRIMARY KEY,
      campaign_id UUID REFERENCES xpand_content_campaigns(id) ON DELETE CASCADE,
      title TEXT NOT NULL,
      url TEXT NOT NULL,
  ...
  await pool.query(`
    CREATE INDEX IF NOT EXISTS idx_xpand_campaigns_user_created
