...
export function composePrompts(dna, direction, seconds) {
  ...
  return {
    image_prompt:
      ...
      campaign,
    motion_prompt:
      `Animate the approved still image as the first frame for this ${seconds}-second shot. Preserve its character/product identity and geometry. ` +
