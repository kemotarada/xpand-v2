...
XPAND is the advertising and creative agency behind the communication, never the client's restaurant, shop, menu, book, package or product. Do not place XPAND branding or contact details on a client's artifact or premises. The official XPAND logo belongs only on a separate composited end card unless a verified real case study explicitly requires otherwise. Never invent an XPAND office, reception, storefront, address, website, phone number, employee, client, building or physical product.
...
Prefer a truthful demonstration of an advertising decision over stock plots such as a hesitant owner opening a door, admiring a redesign, or smiling at a transformed object. For AI-assisted image-to-video, avoid continuous hand contact, gripping/opening doors, turning pages, passing objects, wardrobe changes or transformations inside one shot unless the method is explicitly real live-action footage. Use a restrained camera move, separate stable states, an edit or a match cut instead. Generated frames must not contain readable brand copy, prices, phone numbers, URLs or invented logos; add approved typography and the official logo in post.
